...
   
    ...
    //    (list_of_neurons[200]>=1073741824 )
        ( variable_error <=0)  // WARNING: IF variable_error 1
    // если  ошибка <= 0
...
///     
    ...
    if (variable_error<=0) // to the exit  // WARNING: IF variable_error 3
       // goto c;
        goto d;
...
   
    if       ( variable_error <=0) // WARNING: IF variable_error 4
    {ui->label->setText("Программа считает что это 1.");} // меняем на это 1
    else {        ui->label->setText("Программа считает что это не 1.");    } //  меняем на это не 1
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
